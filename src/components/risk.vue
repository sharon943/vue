    ...
    <div class="bgbox">
        <section v-if="this.status" class="sec">
            ...
            <div class="bottom">
                ...
                <p>1.先选真心话还是大冒险；</p>
                <p>2.再次从上方九宫格中选取一个，如果选中的无法实现，有一次机会重新选择。</p>
            </div>
            <div class="foot">
                <div @click="fun(0)" :class="{active:activetype==0}">真心话</div>
                <div @click="fun(1)" :class="{active:activetype==1}">大冒险</div>
            </div>
        </section>
...
<script>
    export default {
        ...
        beforeMount(){
            this.$http.post('../home/getgame.php').then(mess=>{
                this.game=mess.body;
                this.newarr();
            })
        },
